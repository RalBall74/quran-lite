const translationMap = {
    ...
    "مبرمج و مطور واجهات أمامية": "Front-End Developer",
    "الموقع الشخصي": "Personal Website",
    "باقي أعمالي": "Other Projects",
    "خدمة العملاء (واتساب)": "Customer Service (WhatsApp)",
    "جميع الحقوق محفوظة لشركة تدفق ©": "All rights reserved to Tadfuq ©",
    "برمجة وتصميم: عاصم محمد": "Programming & Design: Assem M Abu Alnasr",
    "تسبيح": "Tasbeeh",
    "تحديد الموقع...": "Detecting Location...",
    "يبقي على أذان": "Time left for",
